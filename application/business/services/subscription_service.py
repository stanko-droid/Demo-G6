...
class SubscriptionService:
    ...
    def subscribe(self, email: str, name: str | None) -> tuple[bool, str]:
        """
        Full subscription flow using the current application context.

        This method orchestrates the complete subscription process:
        1. Validates the email format
        2. Normalizes email and name
        3. Saves to the database (uses current app context)
        ...
        # Save to database using current app context
        try:
